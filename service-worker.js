...
self.addEventListener('fetch', event => {
  ...
  if (event.request.method !== 'GET') {
    ...
    /* Service worker was archived and disabled per user request. */

    /*
      The original service-worker.js has been removed to disable PWA caching.
      If you later decide to re-enable service workers, restore the original
      implementation and re-add the registration code in index.html.
    */

    // noop file to indicate service worker archived.
});
